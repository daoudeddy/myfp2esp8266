...
// (c) R Brown, 2014-2025, All rights reserved.
//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
// NOMENCLATURE COMMON TO ALL BOARDS
//-----------------------------------------------------------------------
// BT     Bluetooth
// BUZZ   Buzzer
...
//-----------------------------------------------------------------------
// myFP2 (Arduino Nano) BOARDS 
// MUST be programmed using myFP2 firmware
//-----------------------------------------------------------------------
...
// A4998_M_MT_F_BT example is (BUZ.LEDs.LCD.OLED.PB.TMP)
...
//-----------------------------------------------------------------------
// myFP2M (Arduino Nano) BOARDS
// MUST be programmed using myFP2M firmware
//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
// myFP2N NEXTION (Arduino Nano) BOARDS
// MUST be programmed using myFP2N firmware
//-----------------------------------------------------------------------
// https://sourceforge.net/projects/arduinoascomfocuserpro2diy/files/myFocuserPro2N%20NEXTION%20TFT%20DISPLAY/
// Video https://www.youtube.com/watch?v=NYa4qjsf1uc
//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
// myFP2ESP8266 (NODEMCU 12-E) BOARDS
// MUST be programmed using myFP2ESP8266 firmware
//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
#define WEMOSDRV8825      35  // WEMOS:DRV8825.NEMA.OLED.TMP 
#define PRO2EDRV8825      36  // NODEMCU-12E:PCB:DRV8825.NEMA.OLED.TMP 
#define PRO2EDRV8825BIG   37  // deprecated
#define PRO2EULN2003      38  // NODEMCU-12E:PCB:ULN2003.28BYJ-48.OLED.TMP
#define PRO2EL293DNEMA    39  // NODEMCU-12E:L293D_MOTOR_SHIELD.NEMA.OLED.TMP 
#define PRO2EL293D28BYJ48 40  // NODEMCU-12E:L293D_MOTOR_SHIELD.28BYJ48.OLED.TMP 
#define PRO2EL298N        41  // L298N      :PCB-ULN2003:L298N.NEMA.OLED.TMP
#define PRO2EL293DMINI    42  // L293DMini  :PCB-ULN2003:L293DMini.NEMA.OLED.TMP
#define PRO2EL9110S       43  // L9110S     :PCB-ULN2003:L9110S.NEMA.OLED.TMP
#define PRO2EDRV8825S     90  // WEMOS D1 R3 SOLDERLESS:DRV8825.NEMA.OLED.TMP
#define PRO2EL298NS       91  // WEMOS D1 R3 SOLDERLESS:L298N.NEMA.OLED.TMP
#define PRO2EULN2003S     92  // WEMOS D1 R3 SOLDERLESS:ULN2003.28BYJ48.OLED.TMP 
#define PRO2EDRV8825DS    93  // DIY SOLDERLESS:DRV8825.NEMA.OLED.TMP
#define PRO2EL298NDS      94  // DIY SOLDERLESS:L298N.NEMA.OLED.TMP
#define PRO2EULN2003DS    95  // DIY SOLDERLESS:ULN2003.28BYJ48.OLED.TMP


//-----------------------------------------------------------------------
// myFP2ESP32 (ESP32 Dev) BOARDS
// MUST be programmed using myFP2ESP32 firmware
//-----------------------------------------------------------------------
...
#define PRO2ESP32LOLINS2MINI 60    // LOLIN ESP32S2 MINI, Set target as LOLIN S2 Mini
#define PRO2ESP32TMC2209LGTM 61    // LilyGo T-Motor (Eric Harant)
#define PRO2ESP32TMC2209XIAOC3 62  // Seed Studio XIAO ESP32C3 (Eric Harant), Set target to ESP32 PICO-D4


//-----------------------------------------------------------------------
// myROTATOR (Arduino Nano) BOARDS
// MUST be programmed using myRotator firmware
//-----------------------------------------------------------------------
...
#define ROTATOR_ESP32_LILYGO  75       // DRVBRD_ESP32_LILYGO, Set target to ESP32 PICO-D4
...
// MUST be programmed using mySQM+ firmware
//-----------------------------------------------------------------------
// https://sourceforge.net/projects/mysqmproesp32/
// Videos https://www.youtube.com/watch?v=zZ-Y9TsLtS8&list=PL2iOz0v_d52hD2dm-PHnZkyzUz1v9cWks
//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
// myESP32-DB boards
// MUST be programmed using myESP32DB firmware
//-----------------------------------------------------------------------
// https://sourceforge.net/projects/mysqmproesp32/
// Videos https://www.youtube.com/playlist?list=PL2iOz0v_d52izLkWU5yqhlKjl5tGMAd74
//-----------------------------------------------------------------------
